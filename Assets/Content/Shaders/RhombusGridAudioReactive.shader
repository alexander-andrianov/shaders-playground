Shader "Unlit/RhombusGridAudioReactive"
{
    Properties
    {
        ...
        _BeatInput ("Beat Input (Set by Script)", Range(0, 1)) = 0.0 
        _BeatEffectIntensity ("Beat Effect Intensity", Range(0.0, 1.0)) = 0.5
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float pulseFactor = (1.0 - _BeatEffectIntensity) + (_BeatInput * _BeatEffectIntensity);
                pulseFactor = saturate(pulseFactor);
